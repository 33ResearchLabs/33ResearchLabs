  ...
  return (
    ...
    <main className=" ">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-5xl lg:text-5xl font-bold mb-6 animate-fade-in relative inline-block group">
              <span className="text-blue-500">33ResearchLabs</span>{" "}
      ...
      <section
        ...
        className="snap-start  flex flex-col justify-center p-6 lg:p-8 bg-white"
      >
        <div className="text-center bg-blue-700 text-white p-8 rounded-2xl shadow-lg">
          <h2 className="text-3xl lg:text-4xl font-bold mb-4 leading-tight">
            Join the Future with{" "}
            <span className="text-blue-200">33Research Labs</span>
          </h2>
          <p className="text-lg mb-6 opacity-90">
            At <strong className="font-semibold">33researchlabs</strong>, we
            believe the next decade of innovation will be shaped by companies
            who build fast, secure, and intelligently. If you're working on
            something ambitious — whether in AI, crypto, or enterprise tech —
            we'd love to be your technical partner.
          </p>
          <p className="text-lg opacity-90">
            Reach out today to see how{" "}
            <strong className="font-semibold">33Research Labs</strong> can help
