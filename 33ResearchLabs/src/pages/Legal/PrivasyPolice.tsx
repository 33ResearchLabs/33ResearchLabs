  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="33 Research Labs Privacy Policy. Learn how we collect, use, and protect your personal information."
        />
        <meta
          name="robots"
          content={generateRobotsContent(ROBOTS_CONFIG.LEGAL)}
        />
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <ul className="list-disc list-inside text-gray-600 mb-4 space-y-2">
            ...
            <li>
              ...
              Address, Browser type/version, Pages visited, Date & time,
              Referral URLs.
            </li>
            <li>
          ...
          <p className="text-gray-600">
            ...
            <a
              ...
              className="text-[#1DA1F2] font-medium flex"
            >
