...
export const EditBlogPage = () => {
    ...
    const fetchBlog = async () => {
      try {
        ...
        const res = await axios.get(
          `${BackendUrl}/api/admin/dashboard/blog/${id}`,
        ...
        setCategory(blog.category || "Blockchain");
        setIcon(blog.icon || "LayersIcon");
        setColor(blog.color || "from-purple-400 to-purple-600");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!title.trim() || !content.trim() || !excerpt.trim() || !author.trim() || !category.trim()) {
      toast.error("Title, content, excerpt, author, and category are required.");
      return;
    }
      ...
      <div className="max-w-3xl mx-auto">
        <Card className="bg-[#1e293b] border border-[#334155]">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    type="text"
                    placeholder="e.g., November 3, 2025"
                    value={date}
              ...
              <div>
                ...
                {imageUrl && (
                  <div className="mt-4">
                    <p className="text-sm text-green-400 mb-2">✓ Current Image:</p>
                    <img
                      src={imageUrl}
                      alt="Blog preview"
              ...
              <div className="flex gap-4">
                <button
                  ...
                  className="bg-blue-500 p-2 hover:bg-blue-600 text-white flex-1 rounded"
                >
                  {showPreview ? "Hide Preview" : "Show Preview"}
                </button>
                <button
                  type="submit"
                  className="bg-orange-500 p-2 hover:bg-orange-600 text-white flex-1 rounded"
                  disabled={updating}
                >
            ...
            {/* Preview Section - Same as NewBlog */}
            {showPreview && (
