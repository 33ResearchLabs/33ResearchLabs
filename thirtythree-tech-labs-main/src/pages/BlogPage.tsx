            ...
            <div className="grid gap-6 md:grid-cols-1 lg:grid-cols-2 max-w-7xl mx-auto">
              {filteredBlogs.map((blog) => (
                <Link
                  ...
                  className="h-full"
                >
                  <div className="h-full min-h-[22rem] bg-white border border-[#334155] rounded-xl p-4 flex flex-col md:flex-row gap-4 shadow-md hover:shadow-orange-500/10 transition-shadow">
                    ...
                    <div className="flex-1 flex flex-col justify-between">
                      ...
                      <div className="flex items-center justify-between mt-auto">
                        <button className="bg-blue-500 text-white rounded-lg py-2 px-5 hover:bg-blue-600 transition-colors">
                          Read full Blog
                        </button>
